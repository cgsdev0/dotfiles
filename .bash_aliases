...
# == Samsara ==
alias unfuck-hooks="[[ \"\$(readlink \$HOME/co/backend/.git/hooks)\" = personal_hooks ]] || (cd \$HOME/co/backend/.git; unlink hooks; ln -s personal_hooks hooks; echo 'Personal hooks restored.')"

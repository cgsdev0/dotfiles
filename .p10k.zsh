# Generated by Powerlevel10k configuration wizard on 2020-09-15 at 02:45 PDT.
...
() {
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_TODO_VISUAL_IDENTIFIER_EXPANSION=$(echo "\UF274")
  ...
  typeset -g POWERLEVEL9K_PYENV_SHOW_ON_COMMAND='pip|pip3|python|python2|python3|virtualenv|pytest'
